...
async def daily_report_handler(message: Message):
    ...
    try:
        ...
        # Уровень 2 (8 пробелов)
        await status_msg.edit_text(f"❌ Произошла ошибка при создании отчёта:\n`{e}`")
        print(f"Критическая ошибка в daily_report_handler: {e}")
